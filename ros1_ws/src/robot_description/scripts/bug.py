...
def main():
    ...
    srv = rospy.Service('bug_service', BugService, bug_service_switch)
    ...
    rospy.wait_for_service('/user_input2')
    srv_client_user_interface_ = rospy.ServiceProxy('/user_input2', SetBool)
