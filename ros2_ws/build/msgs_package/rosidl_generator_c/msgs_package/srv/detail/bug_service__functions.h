...
#ifndef MSGS_PACKAGE__SRV__DETAIL__BUG_SERVICE__FUNCTIONS_H_
#define MSGS_PACKAGE__SRV__DETAIL__BUG_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/BugService message.
/**
...
/// Finalize srv/BugService message.
/**
...
/// Create srv/BugService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msgs_package__srv__BugService_Request__init().
...
/// Destroy srv/BugService message.
/**
 * It calls
 * msgs_package__srv__BugService_Request__fini()
...
/// Initialize array of srv/BugService messages.
/**
...
/// Finalize array of srv/BugService messages.
/**
 * It calls
 * msgs_package__srv__BugService_Request__fini()
...
/// Create array of srv/BugService messages.
/**
 * It allocates the memory for the array and calls
 * msgs_package__srv__BugService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/BugService messages.
/**
 * It calls
 * msgs_package__srv__BugService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msgs_package__srv__BugService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs_package
...
/**
 * It calls
 * msgs_package__srv__BugService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs_package
...
/**
 * It allocates the memory for the array and calls
 * msgs_package__srv__BugService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs_package
...
/**
 * It calls
 * msgs_package__srv__BugService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSGS_PACKAGE__SRV__DETAIL__BUG_SERVICE__FUNCTIONS_H_
